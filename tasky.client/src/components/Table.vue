...
const fetchTasks = async () => {
    try {
        const res = await axios.get(`${import.meta.env.VUE_APP_API_URL}/api/tasks`);
...
const deleteTask = async () => {
    try {
        await axios.delete(`${import.meta.env.VUE_APP_API_URL}/api/tasks/delete/${selectedTaskId.value}`);
...
const editTask = async () => {
    try {
        const response = await axios.patch(`${import.meta.env.VUE_APP_API_URL}/api/tasks/update/${selectedTaskId.value}`, {
